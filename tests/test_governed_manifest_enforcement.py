...
VALID_POLICY_PACK = {
    ...
    "policypack_id": "governed-manifest-lock",
    ...
    "notes": "Governed manifest enforcement lock tests",
}
...
BASE_MANIFEST = {
    ...
    "entrypoint": "tests.test_governed_manifest_enforcement._AlignedAdapter",
    ...
    "notes": "Governed manifest enforcement tests",
}
...
def test_process_with_policy_accepts_manifest_aligned_runtime_path() -> None:
    result = _gateway(_AlignedAdapter(), BASE_MANIFEST).process_with_policy(
        "poi",
        SOURCE_INPUT,
        VALID_POLICY_PACK,
    )
...
def test_process_with_policy_rejects_runtime_envelope_adapter_drift() -> None:
    result = _gateway(_EnvelopeAdapterDriftAdapter(), BASE_MANIFEST).process_with_policy(
        "poi",
        SOURCE_INPUT,
        VALID_POLICY_PACK,
    )
...
def test_process_with_policy_rejects_manifest_declared_action_drift() -> None:
...
def test_process_governed_rejects_output_contract_drift() -> None:
    result = _gateway(_OutputContractDriftAdapter(), BASE_MANIFEST).process_governed(
        "poi",
        SOURCE_INPUT,
        VALID_POLICY_PACK,
    )
...
def test_process_governed_rejects_output_adapter_drift() -> None:
    result = _gateway(_OutputAdapterDriftAdapter(), BASE_MANIFEST).process_governed(
        "poi",
        SOURCE_INPUT,
        VALID_POLICY_PACK,
    )
...
def test_process_governed_rejects_output_task_type_drift() -> None:
    result = _gateway(_OutputTaskTypeDriftAdapter(), BASE_MANIFEST).process_governed(
        "poi",
        SOURCE_INPUT,
        VALID_POLICY_PACK,
    )
